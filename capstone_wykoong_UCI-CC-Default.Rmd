...
+ PAY_1 = -1 (default on SEP 2005) does not always DEFAULT = 1 (default on OCT 2005), and
+ PAY_1 = 1 (pay on time for SEP 2005) does not always DEFAULT = 0 (pay on time for OCT 2005).
...
```{r gamloess_parsedata, eval=TRUE}
result <- rbind(result, c(Method = "LOESS", Accuracy = 0.824195967338777, Balanced = 0.649950110736118,
                               Sensitivity = 0.962550823881875, Specificity = 0.337349397590361, F1 = 0.89503531986867))
```

``` {r gamLoess_modeling, eval=FALSE}
...
``` {r gamLoess_modeling_result, echo=FALSE, eval=FALSE}
...
``` {r loess_confusion_table, echo=FALSE, eval=FALSE}
...
```{r knn_parsedata, eval=TRUE}
result <- rbind(result,  c(Method = "K-NN", Accuracy = 0.787202132977837, Balanced = 0.535641818289636,
                               Sensitivity = 0.986946287181682, Specificity = 0.0843373493975904, F1 = 0.878392534044377))

```

``` {r knn_modeling, eval=FALSE}
set.seed(1,sample.kind = "Rounding")
...
``` {r knn_modeling_result, echo=FALSE, eval=FALSE}
...
``` {r knn_confusion_table, echo=FALSE, eval=FALSE}
...
``` {r kmeans_modeling_result, echo=FALSE, eval=FALSE}
...
``` {r kmean_confusion_table, echo=FALSE, eval=FALSE}
...
``` {r randomforest_parsedata_1, eval=TRUE}
rf_mtry <- c(2,3,4,5,8,10,20,50)
rf_mtree_optimal <- 1200
```

``` {r randomforest_modeling_mtree, eval=FALSE}
set.seed(1,sample.kind = "Rounding")
...
``` {r randomforest_modeling_mtree_part2, echo=FALSE, eval=FALSE}
...
After evaluating several models and with 2 difference variables set, the **Generalized Linear Model** is found to be the best with **F-score of 89.59%** for predicting the probability of a client defauling on Oct 2005 Credit Card payment.
